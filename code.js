window.onload = () => {
    ...
    window.move = function(dir) {
        switch(dir) {
            case 'left': if (direction.dir !== 'right' && direction.change)
                direction = { ...direction, dir: 'left', change: false }; break;
            case 'up': if (direction.dir !== 'bottom' && direction.change)
                direction = { ...direction, dir: 'top', change: false }; break;
            case 'right': if (direction.dir !== 'left' && direction.change)
                direction = { ...direction, dir: 'right', change: false }; break;
            case 'down': if (direction.dir !== 'top' && direction.change)
